...
const PLANS: Record<string, PlanInfo> = {
  STARTER: {
    ...
    features: [
      "Up to 5 products",
      "POS & basic inventory · single staff · 1 location",
      "≈1 month sales history in app",
      "Email support",
      "Shared platform URL only (no branded subdomain or custom domain)",
      "No WhatsApp Flows storefront · no cloud sync",
    ],
  },
  PROFESSIONAL: {
    name: "Professional",
    icon: Crown,
    features: [
      "Up to 50 products · cloud sync",
      "Up to 3 staff · 1 location",
      "Branded vendor subdomain `{slug}.{platform}`",
      "WhatsApp Flows ordering (linked store)",
      "12 months history",
      "Up to 1 connected storefront custom domain",
      "Email & phone support",
    ],
  },
  BUSINESS: {
    ...
    icon: Building,
    features: [
      "Everything in Professional, scaled",
      "Unlimited products & staff · multi-location",
      "API access · priority support · all-time history",
      "One bring-your-own domain for vendor portal (DNS verified)",
      "Up to 5 storefront custom domains",
  ...
  ENTERPRISE: {
    ...
    features: [
      ...
      "Multiple vendor / campaign host aliases & unlimited storefront domains",
      "RFID / loss-prevention tooling (Vendor+)",
      "Dedicated success, SLA options & custom integrations",
    ],
  },
}
