...
import { Search, ScanLine, Package, ShoppingCart, X, CheckCircle2, RotateCcw, LogOut, Plus } from "lucide-react"
...
export function POSView({
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-[calc(100vh-120px)] w-full bg-albaz-bg-gradient dark:bg-albaz-bg-gradient-dark">
      {/* Products Area - Left Side (2/3 width) */}
      <div className="flex-1 flex flex-col overflow-hidden w-full lg:w-2/3 order-1">
        {/* Product Area */}
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          <div className="flex-1 flex flex-col overflow-hidden p-3 md:p-6 min-w-0">
            {/* Search and Barcode */}
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-4 mb-4 sm:mb-6">
              ...
              <Button
                ...
                className="bg-albaz-green-gradient hover:opacity-90 text-white shadow-albaz-green w-full sm:w-auto"
              >
      ...
      <div className="w-full lg:w-1/3 bg-white dark:bg-gray-900 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-800 flex flex-col shadow-xl order-2">
