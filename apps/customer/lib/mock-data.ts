...
export const categories: CategoryDefinition[] = [
  {
    ...
    nameAr: 'متاجر',
    nameFr: 'Boutiques',
    iconImage: '/icons/gifts-icon.png', // Gift/shops icon
  ...
  },
  {
    ...
    iconImage: '/icons/pharmacy-and-supplements-icon.png', // Pharmacy and beauty icon
  ...
  },
  {
    ...
    nameAr: 'بقالة',
    nameFr: 'Épicerie',
    iconImage: '/icons/shops-and-groceries-icon--cart-.png', // Shopping cart with groceries
  ...
  },
  {
    ...
    nameAr: 'طعام',
    nameFr: 'Nourriture',
    iconImage: '/icons/food-icon--pizza-and-burger--.png', // Food items (hamburger, pizza, etc.)
  ...
  },
  {
    ...
    iconImage: '/icons/package-delivery-icon--motorcyle-.png', // Delivery scooter with package
