      ...
      <div className="px-4 py-6">
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <Card
              key={store.id}
              className="albaz-card overflow-hidden cursor-pointer hover:shadow-md transition-shadow border-border focus-within:ring-2 focus-within:ring-[var(--albaz-olive)] focus-within:ring-offset-2"
