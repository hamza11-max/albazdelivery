...
import type { Prisma } from '@/root/generated/prisma/client'
import { RefundStatus } from '@/root/generated/prisma/client'
...
/** List refunds (ADMIN) — same filters as public GET on /api/refunds/create but admin-only path. */
...
/** Create refund for any order with payment (ADMIN). */
